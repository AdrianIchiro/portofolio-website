    ...
    return (
        <section className="mb-10" id="project">
            ...
            <div className="grid lg:grid-cols-2 md:gap-12">
                ...
                <ProjectCard urlImg={'https://www.telkomsel.com/sites/default/files/2023-08/aug-3-01.png'} title={'CoffeJava'} desc={'Online shop for coffee'} url={'https://website-coffejava-ahas9wwp8-adrians-projects-232e110a.vercel.app/'} />
            </div>
        </section>
    )
}
