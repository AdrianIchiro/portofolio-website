    ...
    return (
        <section className="mb-10" id="project">
            ...
            <div className="grid lg:grid-cols-2 md:gap-12">
                <ProjectCard urlImg={'img/project-1.png'} title={'Book Store'} desc={'Library'} url={'https://library-it-website.vercel.app/'}/>
                ...
                <ProjectCard urlImg={'img/project-3.png'} title={'Diawise'} desc={'Prediction diabetes with ai'} url={'https://diawise.streamlit.app/'} />
            </div>
        </section>
    )
}
